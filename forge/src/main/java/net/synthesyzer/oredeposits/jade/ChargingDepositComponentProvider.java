...
public enum ChargingDepositComponentProvider implements IBlockComponentProvider, IServerDataProvider<BlockEntity> {
    ...
    public void appendTooltip(ITooltip tooltip, BlockAccessor accessor, IPluginConfig iPluginConfig) {
        if (accessor.getServerData().contains("chargeTime") && accessor.getServerData().contains("progress")) {
            ...
            tooltip.add(Component.literal("Cooldown: " + chargeTime.subtract(progress)));
        }
    }
